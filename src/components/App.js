...
chooseImage =(cardId)=>{
 ...
 flipCard = async (cardId) => {
    ...
    //console.log(this.state.cardsChosen,this.state.cardsChosenId)
  ...
  checkForMatch=async()=>{
    ...
    if(optionOneId == optionTwoId){
      ...
      alert('images match...congratulation')
    ...
    if(this.state.cardsWon.length===CARD_ARRAY.length){
      alert('congratulation all match found')
    }
  }
          ...
          <div className="row">
            <main role="main" className="col-lg-12 d-flex text-center">
              <div className="content mr-auto ml-auto">
                <h1 className="d-4">Satrt matches</h1>
